...
function build(_config) {
  ...
  return (0, _gulp.src)(config.src).pipe((0, _gulpIf2.default)(config.modularize, (0, _gulpUtil.noop)(), config.sourcemaps ? _gulpSourcemaps2.default.init() : (0, _gulpUtil.noop)())).pipe((0, _gulpIf2.default)(/\.(sass|scss)$/, (0, _gulpSass2.default)({
