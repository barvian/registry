...
function process(config) {
  var pipeline = _gulp2.default.src(config.src).pipe(_gulpSourcemaps2.default.init()).pipe((0, _gulpSass2.default)({
  ...
  .pipe((0, _gulpIf2.default)('*.css', (0, _gulpMinifyCss2.default)({
    mediaMerging: false
...
function load(gulp, config) {
  ...
  gulp.task('styles:clean', function (cb) {
    return (0, _del2.default)((0, _arrayFlatten2.default)([config.dest, '.sass-cache/']), cb);
  });
};
