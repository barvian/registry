...
function compile(config) {
  ...
  var pipeline = _gulp2.default.src(config.src).pipe((0, _gulpIf2.default)(!config.modularize && config.sourcemaps, _gulpSourcemaps2.default.init())).pipe(sassFilter).pipe((0, _gulpSass2.default)({
  ...
  .pipe((0, _gulpIf2.default)('*.css', config.minify ? (0, _gulpMinifyCss2.default)({
    mediaMerging: false
