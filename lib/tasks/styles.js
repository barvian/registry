...
function build(_config) {
  ...
  return (0, _gulp.src)(config.src).pipe((0, _gulpIf2.default)(!config.modularize && config.sourcemaps, _gulpSourcemaps2.default.init())).pipe((0, _gulpIf2.default)(/\.(sass|scss)$/, (0, _gulpSass2.default)({
