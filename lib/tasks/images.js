...
function build() {
  ...
  return _gulp2.default.src(config.src, { since: _gulp2.default.lastRun('images:build') }).pipe((0, _gulpIf2.default)(config.minify, (0, _gulpImagemin2.default)(config.imagemin))).pipe((0, _gulpMultidest2.default)(config.dest)).pipe((0, _browserSync.stream)());
}
