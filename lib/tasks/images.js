...
var logFile = 'images.log';

function process(config) {
  var pipeline = _gulp2.default.src(config.src).pipe((0, _gulpChanged2.default)((0, _arrayFlatten2.default)([config.dest])[0])).pipe((0, _gulpFilelist2.default)(logFile, { flatten: true })).pipe((0, _gulpIf2.default)((0, _env.prod)(), (0, _gulpImagemin2.default)({
    progressive: true,
    interlaced: true,
