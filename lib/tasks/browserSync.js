...
exports.reload = exports.init = exports.stream = exports.browserSync = undefined;
...
var stream = exports.stream = (0, _lazypipe2.default)().pipe(function () {
  return (0, _gulpIf2.default)('!*.map', browserSync.active ? browserSync.stream() : (0, _gulpUtil.noop)());
});
