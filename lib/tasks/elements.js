...
function build(done) {
  ...
  // Styles
  (0, _bindProperties2.default)(styles.build, {
  ...
  // Scripts
  (0, _bindProperties2.default)(scripts.build, {
    all: js(config),
...
function watch() {
  ...
  _gulp2.default.watch([config.base + '/**/*', '!' + config.base + '/**/__tests__/**/*'], (0, _bindProperties2.default)(build, this));
}
...
function test(done) {
  ...
  _gulp2.default.series((0, _bindProperties2.default)(build, this), function (cb) {
