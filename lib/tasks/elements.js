...
function build(done, _config, gulp) {
  ...
  function () {
    ...
    // Strip sourcemaps
    .pipe((0, _gulpReplace2.default)(/^\/[\/\*]\#\s*sourceMapping.*$/gm, '')).pipe((0, _gulpIf2.default)('*.js', config.minify ? (0, _gulpUglify2.default)(scripts.defaultConfig.uglify) : (0, _gulpUtil.noop)())).pipe((0, _gulpMultidest2.default)(config.dest)).pipe((0, _browserSync.stream)());
  })(done);
}
