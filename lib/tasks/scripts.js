...
function lint() {
  ...
  return _gulp2.default.src(config.all).pipe((0, _gulpIf2.default)('*.html', (0, _gulpHtmlExtract2.default)({ strip: true }))).pipe((0, _gulpEslint2.default)({
    parser: 'babel-eslint',
    extends: 'google'
...
function build(done, watch) {
  ...
  _gulp2.default.series(lint.bind(this), function () {
    if (config.bundle) {
      var _ret = (function () {
