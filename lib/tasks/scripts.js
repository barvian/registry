...
function lint(config, gulp) {
  return (0, _gulp.src)(config.all, { since: gulp.lastRun('scripts:lint') }).pipe((0, _gulpIf2.default)('*.html', (0, _gulpHtmlExtract2.default)({ strip: true }))).pipe((0, _gulpEslint2.default)({
    parser: 'babel-eslint',
    extends: 'google'
