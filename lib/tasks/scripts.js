...
function compileBundle(config, watch) {
  ...
  var rebundle = function rebundle() {
    ...
    return watch ? pipeline.pipe((0, _gulpIf2.default)('*.js', _browserSync2.default.stream())) : pipeline;
  };
...
function lint(config) {
  ...
  return _gulp2.default.src(config.all).pipe((0, _gulpIf2.default)('*.html', (0, _gulpHtmlExtract2.default)({ strip: true }))).pipe((0, _gulpEslint2.default)({
    parser: 'babel-eslint',
    extends: 'google'
  })).pipe(_gulpEslint2.default.format()).pipe((0, _gulpIf2.default)(!_browserSync2.default.active, _gulpEslint2.default.failOnError()));
}
...
function load(gulp, config) {
  ...
  gulp.task('scripts:watch', function () {
    return config.bundle ? compileBundle(config, true) : gulp.watch(config.src, function () {
      return compile(config).pipe((0, _gulpIf2.default)('*.js', _browserSync2.default.stream()));
    });
  });
