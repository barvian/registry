...
function build() {
  ...
  return _gulp2.default.src(config.src).pipe((0, _gulpIf2.default)(config.minify, (0, _gulpSvgmin2.default)(config.svgmin))).pipe((0, _gulpSvgstore2.default)()).pipe((0, _gulpRename2.default)(config.bundle)).pipe((0, _gulpMultidest2.default)(config.dest)).pipe((0, _browserSync.stream)());
}
